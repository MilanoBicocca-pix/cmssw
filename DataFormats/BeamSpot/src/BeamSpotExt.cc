/**_________________________________________________________________
   class:   BeamSpotExt.cc
   package: DataFormats/BeamSpotExt
...
namespace reco {
  ...
  void BeamSpotExt::print(std::stringstream& ss) const {
  ...
  //
  std::ostream& operator<< ( std::ostream& os, BeamSpotExt beam ) {
    std::stringstream ss;
    beam.print(ss);
    os << ss.str();
    return os;
  ...
  BeamSpotExt::Covariance3DMatrix BeamSpotExt::rotatedCovariance3D() const
  {
