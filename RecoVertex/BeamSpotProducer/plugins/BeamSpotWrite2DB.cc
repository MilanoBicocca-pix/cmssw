...
{
 std::cout << " Read beam spot data from text file: " 
           << fasciiFileName 
	   << std::endl;
 std::cout << " please see plugins/BeamSpotWrite2DB.cc for format of text file." 
           << std::endl;
 /*
 ...
 */
 ...
 if( poolDbService.isAvailable() ) 
 {
   ...
   else 
   {
     ...
     poolDbService->appendSinceTime<BeamSpotObjects>( 
                                                     abeam, 
