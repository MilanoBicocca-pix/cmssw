...
d0_phi_analyzer = cms.EDAnalyzer("BeamSpotAnalyzer",
	...
	Apply3DFit = cms.untracked.bool(False),
        ...
        minVtxZ = cms.untracked.double(-999.), # in the fit consider only vertices with Z coordinate larger than this
        maxVtxZ = cms.untracked.double(999.), # in the fit consider only vertices with Z coordinate smaller than this
        ...
        maxVertexZ = cms.untracked.double(10), # this one is useless, except you really want to decide some control histo range...
